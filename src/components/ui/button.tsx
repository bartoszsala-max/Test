...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sienna/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-sienna text-white shadow-sm hover:bg-sienna/90 active:scale-95",
        secondary: "bg-teal text-white shadow-sm hover:bg-teal/90 active:scale-95",
        outline: "border border-charcoal/20 bg-transparent hover:bg-charcoal/5 text-charcoal dark:border-ivory/20 dark:text-ivory dark:hover:bg-ivory/5",
        ghost: "hover:bg-charcoal/5 text-charcoal dark:text-ivory dark:hover:bg-ivory/5",
